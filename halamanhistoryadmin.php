                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-8 text-center">
                            ...
                            <table class="table myTable table-bordered ">
                                ...
                                <tbody>
                                    <?php
                                    $sql = mysqli_query($koneksi, "SELECT * FROM history") or die(mysqli_error($koneksi));
                                    while ($row = mysqli_fetch_array($sql)) {
                                    ?>
                                        <tr>
                                            <td data-label="ID"><?php echo $row['id_history']; ?></td>
                                            <td data-label="Tanggal"><?php echo date('d', strtotime($row['datee2']));  ?></td>
                                            <td data-label="Minggu ke-"><?php echo date('W', strtotime($row['datee2']));  ?></td>
                                            <td data-label="Hari"><?php echo date('l', strtotime($row['datee2']));  ?></td>
                                            <td data-label="Bulan"><?php echo date('M', strtotime($row['datee2'])); ?></td>
                                            <td data-label="Tuhan"><?php echo date('Y', strtotime($row['datee2'])); ?></td>
                                        </tr>
                                                                ...
                                                                <div class="row mb-4">
                                                                    <div class="col">
                                                                        <div class="form-group" style="padding:1px 30px;">
                                                                            ...
                                                                            <input type="text" class="form-control" name="ulasan" value="<?php echo $row['ulasan']; ?>" oninvalid="this.setCustomValidity('Masukkan harus berupa angka saja!')" onchange="try{setCustomValidity('')}catch(e){}" oninput="setCustomValidity(' ')" pattern="[0-9]+" required>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="row mb-4">
                                                                    ...
                                                                    <div class="col">
                                                                        <div class="form-group" style="padding:1px 30px;">
                                                                            ...
                                                                            <input type="text" class="form-control" name="download" value="<?php echo $row['download']; ?>" oninvalid="this.setCustomValidity('Masukkan harus berupa angka saja!')" onchange="try{setCustomValidity('')}catch(e){}" oninput="setCustomValidity(' ')" pattern="[0-9]+" required>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row mb-4">
                                                                    ...
                                                                    <div class="col">
                                                                        <div class="form-group" style="padding:1px 30px;">
                                                                            ...
                                                                            <input type="text" class="form-control" name="size" value="<?php echo $row['size']; ?>" oninvalid="this.setCustomValidity('Masukkan harus berupa angka saja!')" onchange="try{setCustomValidity('')}catch(e){}" oninput="setCustomValidity(' ')" pattern="[0-9]+" required>
                                                                        </div>
                                                                    </div>
                                                                </div>
